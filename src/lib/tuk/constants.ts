...
export const ONBOARD = [
  ...
  { big: "태그가 틀리면\n고쳐주세요", small: "기록을 누르면 '태그 고치기'가 나와요.\n당신이 고칠수록 툭이 당신의 표현을 배워서\n다음부턴 더 정확하게 붙여요." },
  { big: "띄엄띄엄 살아도\n기록은 남아요", small: "며칠 빼먹어도 잔소리 없어요.\n한 달에 한 번, 당신이 던진 것들이\n한 그루 나무로 자라나요." },
  { big: "툭은 계속\n자라는 중이에요", small: "알림, 위젯, 더 많은 카테고리...\n조금씩 나아질 거예요.\n불편한 건 설정에서 툭, 건의해주세요." },
];

// 건의하기 수신 주소. 도메인 전달 주소라 개인 메일이 드러나지 않는다.
export const FEEDBACK_EMAIL = "hello@tukapp.cloud";
